...
//
#define RAZAUSER @"Mainrazauser"
#define RAZAMESSAGEUSERRESEND @"Messageresend"
#define RAZASIDEBARLENGTH @"SIDEBARLENGTH"
#define RAZAMESSAGEUSERRESENDMESSAGE @"Resend message sucessfully!"
#define RAZAPUSHCONTACT @"RazaPushcontact"
#define RAZAPUSHCOunter @"RazaPushcounter"
#define MAINRAZASIPURL @"razasip.voipxonline.com"   //@"razasandbox1.voipxonline.com"////@"razadevapp.voipxonline.com"//
...
#define kColorHeader [UIColor colorWithRed:4.0/255.0f green:165.0/255.0f blue:246.0/255.0f alpha:1.0f]

#define kColorKeyboard [UIColor colorWithRed:4.0/255.0f green:165.0/255.0f blue:246.0/255.0f alpha:1.0f]
#define OxfordBlueColor [UIColor colorWithRed:11.0/255.0f green:32.0/255.0f blue:62.0/255.0f alpha:1.0f]
#define AzureColor [UIColor colorWithRed:2.0/255.0f green:130.0/255.0f blue:233.0/255.0f alpha:1.0f]
...
#define Raza_terms @"http://razaimages.razatelecom.com/profile/"
#define RAZA_PROFILE @"http://razaimages.razatelecom.com/profile/profile-images/"//@"http://54.149.13.57/profile/profile-images/"//
#define RAZA_UPLOADPROFILE_IMAGE @"http://razaimages.razatelecom.com/profile/profileUpload.php"//@"http://54.149.13.57/profile/profileUpload.php"//
#define RAZA_REMOVE_IMAGE @"http://razaimages.razatelecom.com/profile/profileImageRemove.php"
#define RAZA_PROFILETHUMB @"http://razaimages.razatelecom.com/profile/profile-thumbimages/"
#define RAZALOGGEDIMAGE @"rjuserimage"
...
#define RAZARECHARGEDONE  @"Recharge done sucessfully!"
#define RAZAPUSHVIDEOCALLMESSAGE  @"Connecting your call..."

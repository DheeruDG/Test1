...
- (void)setupFloatLabel
{
    ...
    _floatLabel.font =[UIFont fontWithName:@"SourceSansPro-Bold" size:14.0];//SourceSansPro-Bold
    ...
    NSString *loginInfo = [RAZA_USERDEFAULTS objectForKey:@"LOGIN"];

    if (loginInfo.length>0){
        //Login
        // colors
        _floatLabelPassiveColor = OxfordBlueColor;
        _floatLabelActiveColor = OxfordBlueColor;// kColorHeader;
    }else{

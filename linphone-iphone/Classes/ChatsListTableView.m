...
static void chatTable_free_chatrooms(void *data) {
    ...
    ///  LinphoneChatMessage *last_msg = linphone_chat_room_get_user_data(_chatRoom);
    //if (!last_msg)
    // linphone_core_delete_chat_room(linphone_chat_room_get_core(_chatRoom), _chatRoom);
}
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        //TODO:UMENIT Delete razapush
        [[Razauser SharedInstance]deletepushfromchat:chatRoom];
        ...
        [NSNotificationCenter.defaultCenter postNotificationName:@"CHATDELETED" object:self];

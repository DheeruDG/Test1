...
@interface CallView : TPMultiLayoutViewController <UIGestureRecognizerDelegate, UICompositeViewDelegate> {
  @private
    ...
    NSString *ll;
    NSString *testvariable;
    NSString *variableforremotepause;
    UIView *confranceview;
    UIButton *btnResumeConfrance;
    UIButton *btnAddConfrance;
    UILabel *lblConfrance;
    OrderedDictionary *addressBookMap;
    NSString *callType;

}
@property (weak, nonatomic) IBOutlet UILabel *nameLblKeyBorad;
@property (weak, nonatomic) IBOutlet UILabel *durationLblKeyboard;
@property (weak, nonatomic) IBOutlet UILabel *videoNameLbl;
@property (weak, nonatomic) IBOutlet UILabel *videoDurationLbl;

@property (weak, nonatomic) IBOutlet UIView *numPadBGView;
...
@property (weak, nonatomic) IBOutlet UILabel *lblremotepaused;
@property (weak, nonatomic) IBOutlet UIImageView *imgremotepause;
@property (weak, nonatomic) IBOutlet UILabel *callTypeLbl;
@property (weak, nonatomic) IBOutlet UIIconButton *chatBtn;

...
- (void)setCall:(LinphoneCall *)call {
	...
	if (!call) {
      ...
      // [_pauseButton setImage:[UIImage imageNamed:@"callplay"] forState:UIControlStateNormal];
        //[_pauseButton setImage:[UIImage imageNamed:@"callplay"] forState:UIControlStateSelected];
       ...
       // [_pauseButton setImage:[UIImage imageNamed:@"pause_small_default.png"] forState:UIControlStateNormal];
        //[_pauseButton setImage:[UIImage imageNamed:@"pause_small_default.png"] forState:UIControlStateSelected];
	}
    [_pauseButton setImage:[UIImage imageNamed:@"callplay"] forState:UIControlStateNormal];
    [_pauseButton setImage:[UIImage imageNamed:@"callplay"] forState:UIControlStateSelected];
	[_pauseButton update];

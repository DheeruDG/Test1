...
@implementation RazaSipLoginModel
-(void)setupforlogin
{
...
void assistant_is_account_used1(LinphoneAccountCreator *creator, LinphoneAccountCreatorStatus status, const char *resp) {
 RazaSipLoginModel *thiz = (__bridge RazaSipLoginModel *)(linphone_account_creator_get_user_data(creator));
...
- (void)configureProxyConfig {
    ...
    if (type) {
        ...
        linphone_account_creator_set_transport(account_creator,LinphoneTransportTcp
                                               );
    }
...
-(void)setconf
{
    NSString *loggeduser=@"9900000088";
    ...
    NSString *loggeduserpass=@"testumenit123@123";
    linphone_account_creator_set_password(account_creator, loggeduserpass.UTF8String);
    NSString *loggeduserdomain=@"razasip.voipxonline.com";
